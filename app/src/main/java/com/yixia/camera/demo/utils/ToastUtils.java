...
public class ToastUtils {
	...
	public static void showToast(int resID) {
		showToast(IMApplication.getInstance(), Toast.LENGTH_SHORT,
				resID);
	}

	public static void showToast(String text) {
		showToast(IMApplication.getInstance(), Toast.LENGTH_SHORT, text);
	}
	...
	public static void showLongToast(int resID) {
		showToast(IMApplication.getInstance(), Toast.LENGTH_LONG, resID);
	}
	...
	public static void showLongToast(String text) {
		showToast(IMApplication.getInstance(), Toast.LENGTH_LONG, text);
	}

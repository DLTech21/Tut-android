...
public class VideoPlayerActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCoverPath = getIntent().getStringExtra("cover_path");
		justDisplay = getIntent().getBooleanExtra("justDisplay", false);
		...
		textRigth = (TextView)findViewById(R.id.txt_right);
		...
		if (justDisplay)
			textRigth.setVisibility(View.INVISIBLE);
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.txt_right:
			ShortVideoPubEvent shortVideoPubEvent = new ShortVideoPubEvent(mCoverPath, mPath);
			EventBus.getDefault().post(shortVideoPubEvent);
			finish();
			break;
			case R.id.root:
				if (justDisplay)

...
public class MobileSideBar extends View{
    private Paint paint;
    ...
    public MobileSideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(){
        ...
        paint.setTextSize(ScreenUtil.instance(context).dip2px(10));
    }
    ...
    private void setHeaderTextAndscroll(MotionEvent event){
        ...
        header.setText(headerString);
          ...
          MobileAdapter  adapter = (MobileAdapter) ha.getWrappedAdapter();

package com.dtalk.dd.ui.adapter.album;
...
import com.dtalk.dd.ui.activity.PickPhotoActivity;
 ...
 */
public class AvatarImageGridAdapter extends BaseAdapter {
    ...
    public AvatarImageGridAdapter(Activity act, List<ImageItem> list, Handler mHandler) {
        this.activity = act;

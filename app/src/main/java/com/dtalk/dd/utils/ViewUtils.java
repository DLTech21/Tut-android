...
public class ViewUtils {
	...
	public static int getResId(String resName, String defType) {
		try {
			String packageName = IMApplication.getInstance().getPackageName();
			Resources resources = IMApplication.getInstance().getPackageManager().getResourcesForApplication(packageName);
...
//		MToast.showMessage(message);
		Toast.makeText(IMApplication.getInstance(), message, Toast.LENGTH_SHORT).show();
	}

	public static void showMessage(int messageId) {
//		MToast.showMessage(messageId);
		Toast.makeText(IMApplication.getInstance(), messageId, Toast.LENGTH_SHORT).show();
	}

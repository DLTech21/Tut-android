...
public class IMGroupManager extends IMManager {
    ...
    private void reqGetNormalGroupList() {
        ...
        Logger.e("group#send packet to server");
    }
    ...
    public void onRepNormalGroupList(IMGroup.IMNormalGroupListRsp normalGroupListRsp) {
        ...
        Logger.e("group#onRepNormalGroupList cnt:%d" + groupSize);
...
//        });
    ...
    public void onRspCreateTempGroup(IMGroup.IMGroupCreateRsp groupCreateRsp) {
        Logger.e("group#onReqCreateTempGroup");

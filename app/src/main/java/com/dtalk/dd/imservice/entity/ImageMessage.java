...
//        try {
//            json.put("url", MessageConstant.IMAGE_MSG_START
//                    + url + MessageConstant.IMAGE_MSG_END);
//            json.put("local", getPath());
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
//        String sendContent = json.toString();
        /**
         * 加密
         */
        try {
            String base64String = new String(Base64.encode(sendContent.getBytes("utf-8"), Base64.DEFAULT));

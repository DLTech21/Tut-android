...
import com.dtalk.dd.imservice.callback.ListenerQueue;
import com.dtalk.dd.imservice.callback.Packetlistener;
import com.dtalk.dd.imservice.event.SocketEvent;
import com.dtalk.dd.imservice.network.MsgServerHandler;
import com.dtalk.dd.imservice.network.SocketThread;
import com.dtalk.dd.protobuf.IMBaseDefine;
import com.dtalk.dd.protobuf.base.DataBuffer;
import com.dtalk.dd.protobuf.base.DefaultHeader;
...
public class IMSocketManager extends IMManager {
    ...
    public void sendRequest(GeneratedMessageLite requset,int sid,int cid,Packetlistener packetlistener){
        ...
        try{
            //组装包头 header
            com.dtalk.dd.protobuf.base.Header header = new DefaultHeader(sid, cid);
    ...
    public void packetDispatch(ChannelBuffer channelBuffer){
        ...
        com.dtalk.dd.protobuf.base.Header header = new com.dtalk.dd.protobuf.base.Header();
...
//        });
    ...
    private MsgServerAddrsEntity onRepLoginServerAddrs(JSONObject json)
        ...
        if (code != 0) {
            Logger.e("login#code is not right:%d, json:", code+"", json.toString());
            return null;
        }
